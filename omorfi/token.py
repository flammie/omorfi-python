...
class Token:
    ...
    def fromconllu(conllu: str):
        ...
        ufeats = fields[5]
        misc = fields[9]
        omor = Analysis.fromomor("[WORD_ID=" + wordid + "]" +
                                 "[UPOS=" + upos + "]" +
    ...
    def fromvislcg(s: str):
        ...
        for line in lines:
            ...
            if not line or line == "":
                ...
                anal = Analysis.fromvislcg(line.strip())
                token.analyses.append(anal)
            elif line.startswith(";\t\""):
                # gold?
                anal = Analysis.fromvislcg(line[1:].strip())
